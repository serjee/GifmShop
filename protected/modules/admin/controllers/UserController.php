...
class UserController extends AdminController
{
	...
	{
        $this->pageTitle=Yii::app()->name . ' - ' . Yii::t('admin', 'User Management');
	...
	{
        $this->pageTitle=Yii::app()->name . Yii::t('admin', 'Create new user');
        ...
        if(isset($_POST['AdminUser']))
        {
            ...
            if($model->validate('createUser'))
            {
                if($model->save())
                {
                    ...
                    Yii::app()->user->setFlash('createMessage',Yii::t('admin', 'The user has been created successfully!'));
                    $this->redirect(array("/admin/user/create"));
                }
                else
                {
                    $model->addError('email', Yii::t('admin', 'Unknow error. Please contact with us by E-mail: {admin_email}', array('{admin_email}'=>Yii::app()->params['adminEmail'])));
	...
	public function actionUpdate($id)
	{
        ...
        if(isset($_POST['AdminUser']))
        {
            ...
            if($model->save())
            {
                Yii::app()->user->setFlash('updateMessage',Yii::t('admin', 'The user has been edited successfully!'));
	...
	public function actionDelete($id)
	{
        if(Yii::app()->request->isPostRequest)
        {
            ...
            throw new CHttpException(400,Yii::t('admin', 'Invalid request. Please do not repeat this request again'));
	}
