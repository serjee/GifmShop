...
class User extends CActiveRecord
{
	...
	public function rules()
	{
		...
		$rules = array(
            ...
            array('password', 'compare', 'compareAttribute'=>'confirmPassword', 'on'=>'regUser', 'message'=>Yii::t('user', 'Retype Password is incorrect.')),
            array('email', 'email', 'message'=>Yii::t('user', 'Invalid email')),
            array('email', 'unique', 'message'=>Yii::t('user', 'Email already exists')),
